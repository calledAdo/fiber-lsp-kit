/* @ts-self-types="./linkage_prover.d.ts" */
 ...
 * @returns {string}
 */
function prove_wasm(zkey, wtns) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(zkey, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(wtns, wasm.__wbindgen_export3);
        const len1 = WASM_VECTOR_LEN;
        wasm.prove_wasm(retptr, ptr0, len0, ptr1, len1);
...
const wasmPath = `${__dirname}/linkage_prover_bg.wasm`;
